...
tmux send-keys -t $TMUX_S:0.1 "./cmd/sub-lb1.sh" C-m
tmux send-keys -t $TMUX_S:0.2 "./cmd/sub-lb1.sh" C-m
tmux send-keys -t $TMUX_S:0.3 "./cmd/sub-lb2.sh" C-m
tmux send-keys -t $TMUX_S:0.4 "./cmd/sub-lb2.sh" C-m
tmux send-keys -t $TMUX_S:0.5 "./cmd/sub-lb2.sh" C-m
...
tmux select-pane -t $TMUX_S:0.1 -P bg=#275e3c,fg=#c8dacf
tmux select-pane -t $TMUX_S:0.2 -P bg=#275e3c,fg=#c8dacf
