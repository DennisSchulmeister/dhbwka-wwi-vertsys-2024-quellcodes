...
logger.info(chalk.bold("Knight Rider -- Das Node.js Programm -- Empfänger"));
...
const topic = process.argv[3] === "lb" ? process.env.MQTT_SUBSCRIBE_TOPIC_LB : process.env.MQTT_SUBSCRIBE_TOPIC;
