...
tmux send-keys -t 1 "./cmd/sub.sh" C-m
tmux send-keys -t 2 "./cmd/sub.sh" C-m
tmux send-keys -t 3 "./cmd/sub.sh" C-m
tmux send-keys -t 4 "./cmd/sub.sh" C-m
tmux send-keys -t 5 "./cmd/sub.sh" C-m
...
tmux select-pane -t 1 -P bg=#234973,fg=#d6dfe9
tmux select-pane -t 2 -P bg=#234973,fg=#d6dfe9
