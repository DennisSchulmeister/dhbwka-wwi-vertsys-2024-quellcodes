...
const defaultData = {
    Parcels: [
        {
            id:       1,
            sender:   "Prof. Farnsworth",
            receiver: "Prof. Farnsworth",
            content:  "Weltuntergangsmaschine",
        },
        {
            id:       2,
            sender:   "Prof. Farnsworth",
            receiver: "Universität des Mars",
            content:  "Universum in einer Box",
        },
        {
            id:       3,
            sender:   "Mom Corp.",
            receiver: "Ford Space Cars",
            content:  "Ersatzteile für Biegeeinheit",
        },
        {
            id:       4,
            sender:   "DOPE-Weltregierung",
            receiver: "Regierung des 3ten Planeten im Las Vegas System",
            content:  "Weltraumameisen",
        },
    ],
    ...
    Flights: [
        {
            id:        1,
            startDate: new Date("3024-03-19T12:00:00Z"),
            endDate:   new Date("3024-03-19T18:30:00Z"),
            parcels:   [1, 2, 3],
        },
        {
            id:        2,
            startDate: new Date("3024-03-20T11:15:00Z"),
            endDate:   new Date("3024-03-21T21:30:00Z"),
            parcels:   [4],
        },
    ],
};
